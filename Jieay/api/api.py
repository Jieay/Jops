...
from Jieay.settings import *
from django.core.paginator import Paginator, EmptyPage, InvalidPage
from django.http import HttpResponse, Http404
from django.template import RequestContext
from Juser.models import User, UserGroup
#from jlog.models import Log, TtyLog
#from swasset.models import Asset, AssetGroup
#from swminpc.models import Salt, SaltArea
...
def validate(request, user_group=None, user=None, edept=None):
    """
...
def verify(request, user_group=None, user=None, edept=None):
    dept = get_session_user_dept(request)[1]
    if edept:
        if dept.id != int(edept[0]):
            return False
